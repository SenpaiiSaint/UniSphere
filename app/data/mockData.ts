...
const generateRandomPerformance = () => {
  ...
  return {
    attendance:
      Math.floor(Math.random() * attendanceVariations[attendanceRange]) +
      attendanceBases[attendanceRange],
    grade:
      Math.floor(Math.random() * gradeVariations[gradeRange]) +
      gradeBases[gradeRange],
...
const generateStudents = () => {
  ...
  for (let i = 1; i <= 40; i++) {
    ...
    students.push({
      ...
      riskFactors: [
        ...(cs101Performance.attendance < 85
          ? ["Low attendance in CS101"]
          : []),
        ...(cs201Performance.attendance < 85
          ? ["Low attendance in CS201"]
          : []),
        ...(cs301Performance.attendance < 85
          ? ["Low attendance in CS301"]
          : []),
        ...(cs401Performance.attendance < 85
          ? ["Low attendance in CS401"]
          : []),
        ...(cs501Performance.attendance < 85
          ? ["Low attendance in CS501"]
          : []),
        ...(cs101Performance.lateSubmissions > 1
          ? ["Frequent late submissions in CS101"]
          : []),
        ...(cs201Performance.lateSubmissions > 1
          ? ["Frequent late submissions in CS201"]
          : []),
        ...(cs301Performance.lateSubmissions > 1
          ? ["Frequent late submissions in CS301"]
          : []),
        ...(cs401Performance.lateSubmissions > 1
          ? ["Frequent late submissions in CS401"]
          : []),
        ...(cs501Performance.lateSubmissions > 1
          ? ["Frequent late submissions in CS501"]
          : []),
      ],
    });
  }
...
export const mockAssignments: Assignment[] = [
  {
    ...
    submissions: mockSubmissions.filter(
      (s) => s.assignmentName === "Programming Assignment 1"
    ),
    rubric: [
      {
        ...
        weight: 40,
        criteria:
          "Program must correctly perform all basic arithmetic operations",
      },
      {
  ...
  },
  {
    ...
    type: "Project",
    submissions: mockSubmissions.filter(
      (s) => s.assignmentName === "Data Structures Project"
    ),
    rubric: [
      {
  ...
  },
  {
    ...
    type: "Homework",
    submissions: mockSubmissions.filter(
      (s) => s.assignmentName === "Algorithm Analysis"
    ),
    rubric: [
      {
  ...
  },
  {
    ...
    type: "Project",
    submissions: mockSubmissions.filter(
      (s) => s.assignmentName === "Database Design"
    ),
    rubric: [
      {
        category: "Design",
  ...
  },
  {
    ...
    type: "Project",
    submissions: mockSubmissions.filter(
      (s) => s.assignmentName === "Software Project"
    ),
    rubric: [
      {
        category: "Functionality",
...
export const mockCourses: Course[] = [
  ...
  },
  {
    ...
    code: "CS201",
    description:
      "Study of fundamental data structures and algorithms with practical implementations.",
  ...
  },
  {
    ...
    code: "CS301",
    description:
      "Advanced study of algorithms and their applications in computer science.",
  ...
  },
  {
    ...
    code: "CS401",
    description:
      "Design and implementation of database systems and applications.",
  ...
  },
  {
    ...
    code: "CS501",
    description:
      "Principles and practices of software engineering and development.",
...
export const mockMessages: Message[] = [
  {
    ...
    content:
      "Hi, I was wondering if you could clarify the requirements for the third section of Assignment 3. The instructions seem a bit unclear about the expected output format.",
  ...
  },
  {
    ...
    content:
      "Just wanted to let you know that I've completed my part of the group project. You can find the updated files in our shared folder.",
  ...
  },
  {
    ...
    content:
      "Would you be available for a quick meeting tomorrow to discuss your progress in the course? I'd like to review your recent assignments and provide some feedback.",
  ...
  },
  {
    ...
    content:
      "This is a reminder that your submission for Assignment 2 was received after the deadline. Please review the late submission policy in the course syllabus.",
  ...
  },
  {
    ...
    content:
      "I've uploaded new study materials for next week's topics. Make sure to review them before the class.",
