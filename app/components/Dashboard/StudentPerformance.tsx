...
import { GraduationCap, TrendingUp, TrendingDown, Users, BookOpen, Clock } from 'lucide-react'
import {
  Chart as ChartJS,
  ArcElement,
  Tooltip,
...
export const StudentPerformance = () => {
  const [selectedCourse, setSelectedCourse] = useState<CoursePerformance>(mockCoursePerformance[0])
    ...
    <div className='bg-white rounded-lg shadow p-4'>
      <div className='flex items-center justify-between mb-4'>
        ...
        <select
          ...
          onChange={(e) => {
            const course = mockCoursePerformance.find(c => c.courseCode === e.target.value)
        ...
        <div className='space-y-4'>
          <div className='bg-gray-50 rounded-lg p-4'>
            <div className='flex justify-between items-start mb-2'>
              <div>
                <h3 className='font-medium text-gray-900'>{selectedCourse.courseCode}</h3>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div className='flex-1'>
                  <div className='flex justify-between text-sm'>
                    ...
                    <span className='font-medium'>{selectedCourse.averageGrade}%</span>
                  </div>
                </div>
              </div>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div className='flex-1'>
                  <div className='flex justify-between text-sm'>
                    ...
                    <span className='font-medium'>{selectedCourse.attendance}%</span>
                  </div>
                </div>
              </div>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div className='flex-1'>
                  <div className='flex justify-between text-sm'>
                    ...
                    <span className='font-medium'>{selectedCourse.lateSubmissions}</span>
                  </div>
                </div>
              </div>
            </div>
